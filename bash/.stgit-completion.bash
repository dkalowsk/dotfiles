...
_stg_edit ()
{
    local flags="--ack --authdate --authemail --authname --author --diff --diff-opts --edit --file --help --message --review --save-template --set-tree --sign"
    local prev="${COMP_WORDS[COMP_CWORD-1]}"
    local cur="${COMP_WORDS[COMP_CWORD]}"
    case "$prev" in
...
_stg_new ()
{
    local flags="--ack --authdate --authemail --authname --author --file --help --message --review --save-template --sign"
    local prev="${COMP_WORDS[COMP_CWORD-1]}"
    local cur="${COMP_WORDS[COMP_CWORD]}"
    case "$prev" in
        --author) COMPREPLY=($(compgen -A file -- "$cur")) ;;
...
_stg_refresh ()
{
    local flags="--ack --annotate --authdate --authemail --authname --author --edit --file --force --help --index --message --patch --review --sign --update"
    local prev="${COMP_WORDS[COMP_CWORD-1]}"
    local cur="${COMP_WORDS[COMP_CWORD]}"
    case "$prev" in
